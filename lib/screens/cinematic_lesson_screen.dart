...
class CinematicLessonScreen extends StatefulWidget {
  ...
  const CinematicLessonScreen(
      {super.key, required this.bgUrl, required this.teacherUrl});
...
class _CinematicLessonScreenState extends State<CinematicLessonScreen> {
  ...
  void initState() {
    super.initState();
    _bgCtrl = CachedVideoPlayerController.network(widget.bgUrl)
      ..initialize().then((_) {
        _bgCtrl.setLooping(true);
        _bgCtrl.play();
      });
    _teacherCtrl = CachedVideoPlayerController.network(widget.teacherUrl)
      ..initialize().then((_) {
        _teacherCtrl.play();
        setState(() {});
      });
            ...
            SizedBox.expand(
                child: FittedBox(
                    ...
                    child: SizedBox(
                        ...
                        child: CachedVideoPlayer(_bgCtrl)))),
