...
class _WatchToUnlockScreenState extends State<WatchToUnlockScreen> {
      ...
      if (status == -1) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text("✅ 24 HOURS PRO UNLOCKED!"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          title: const Text("Unlock For Free 🎁"),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Get 24 Hours of Pro",
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 24,
                    fontWeight: FontWeight.bold)),
            const Text(
                "Can't pay? No problem. Watch 3 short videos to unlock GPT-4, Vedic Math, and X-Ray Vision for 24 hours.",
            ...
            Text("Videos Watched: $adsWatched / 3",
