...
class _QuizSetupScreenState extends State<QuizSetupScreen> {
  ...
  void initState() {
    super.initState();
    QuizCategoryService.getCategories()
        .then((c) => setState(() => categories = c));
  }
  ...
  void _start() {
    ...
    String apiUrl =
        "https://opentdb.com/api.php?amount=10&category=$selectedId&difficulty=$difficulty&type=multiple";

    // Navigate to Quiz Screen with this specific URL
    Navigator.push(
        context, MaterialPageRoute(builder: (_) => QuizScreen(apiUrl: apiUrl)));
  }
              ...
              children: ["easy", "medium", "hard"]
                  .map((d) => Padding(
                        ...
                        child: ActionChip(
                          ...
                          backgroundColor:
                              difficulty == d ? Colors.blue : Colors.white10,
