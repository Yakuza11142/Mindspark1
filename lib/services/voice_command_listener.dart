...
class VoiceCommandListener {
  ...
  Future<String> _aiContextCorrector(String rawSpeech) async {
    try {
      final model =
          GenerativeModel(model: 'gemini-3.1-flash', apiKey: Secrets.geminiKey);
      final prompt =
          "The user used speech-to-text to ask a question. Fix any typos or misheard words based on a Nigerian academic context. Return ONLY the corrected sentence: '$rawSpeech'";
