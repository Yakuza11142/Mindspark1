...
class NativeArLauncher {
  static Future<void> launchHologram(String glbUrl, String title) async {
    ...
    print(
        "🚀 Bypassing Flutter... Forcing Native Android Scene Viewer for: $title");
    ...
    final String intentUri = "intent://arvr.google.com/scene-viewer/1.0"
    ...
    try {
      ...
      if (await canLaunchUrl(uri)) {
        ...
        print(
            "❌ CRITICAL: Google ARCore is missing or disabled on this device.");
        // Fallback: Just open the 3D model in a normal web browser
        await launchUrl(Uri.parse(
            "https://modelviewer.dev/?src=${Uri.encodeComponent(glbUrl)}"));
      }
    } catch (e) {
