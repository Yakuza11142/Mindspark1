...
class EliteCertificateService {
  static Future<void> createAndShare({
    ...
    pdf.addPage(pw.Page(
      ...
      build: (pw.Context context) =>
          _buildImageStyleLayout(studentName, practicalName, autoDate),
    ));
  ...
  static pw.Widget _buildImageStyleLayout(
      String name, String practical, String date) {
    return pw.Container(
        ...
        child: pw.Stack(
          children: [
            ...
            pw.Positioned(
                ...
                right: 10,
                child:
                    pw.Transform.rotate(angle: 1.57, child: _floralCorner())),
            pw.Positioned(
                bottom: 10,
                left: 10,
                child:
            ...
            pw.Positioned(
                ...
                right: 10,
                child:
                    pw.Transform.rotate(angle: 3.14, child: _floralCorner())),

            pw.Padding(
              padding:
                  const pw.EdgeInsets.symmetric(horizontal: 60, vertical: 30),
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text("Issued by Mind Spark AI Academy on $date",
                      style: const pw.TextStyle(
                          fontSize: 14)), // Auto-date displays here
...
// 🚀 CI AUTO-REMOVED:                       _signatureBlock("THE FOUNDER"),
  ...
  static pw.Widget _floralCorner() => pw.Text("❧",
      style: pw.TextStyle(fontSize: 40, color: PdfColors.amber700));
