class ExamContextInjector {
  ...
  static const Map<String, String> _globalKnowledge = {
    "SAT":
        "US College Board standards, algebraic reasoning, and US Imperial units.",
    ...
    "GAOKAO":
        "Chinese National Entrance standards, deep analytical complexity.",
    "WAEC":
        "West African WASSCE standards, structured essay and objective formats.",
    "MCAT":
        "Medical College Admission standards, biological and biochemical foundations.",
  };
