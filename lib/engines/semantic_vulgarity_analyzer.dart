...
class SemanticVulgarityAnalyzer {
  static Future<bool> isVulgarOrInappropriate(String userInput) async {
    ...
    final RegExp basicBadWords = RegExp(
        r'\b(fuck|shit|cunt|dick|pussy|porn|sex|nude)\b',
        caseSensitive: false);
    ...
    try {
      ...
      final prompt =
          "Analyze this text: '$userInput'. Does it contain profanity, sexual requests, extreme violence, or severe Nigerian insults (like 'olosho', 'ashawo')? Answer strictly 'YES' or 'NO'.";
