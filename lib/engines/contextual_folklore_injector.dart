class ContextualFolkloreInjector {
  ...
  static const Map<String, String> _mythologyRegistry = {
    'Yoruba_electricity':
        "Relate the concept of electrical currents and voltage to the mythology of Sango, the God of Thunder, to make it culturally memorable.",
    'Igbo_electricity':
        "Relate the concept of lightning and energy to Amadioha to make it culturally memorable.",
  };
  ...
  static String applyMythology(String topic, String language) {
    ...
    return _mythologyRegistry[lookupKey] ??
        "Explain using standard local examples.";
  }
}
