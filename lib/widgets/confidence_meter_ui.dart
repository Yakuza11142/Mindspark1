...
class ConfidenceMeterUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double confidence = (drillsCompletedToday / 10)
        .clamp(0.0, 1.0); // Max confidence at 10 drills
    Color c = confidence < 0.5
        ? Colors.red
        : (confidence < 0.8 ? Colors.orange : Colors.greenAccent);

    return Column(
      children: [
        const Text("Exam Readiness Level",
        ...
        Text("${(confidence * 100).toInt()}% Prepared",
