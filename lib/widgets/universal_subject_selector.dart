...
class UniversalSubjectSelector extends StatefulWidget {
  ...
  @override
  State<UniversalSubjectSelector> createState() =>
      _UniversalSubjectSelectorState();
}
...
class _UniversalSubjectSelectorState extends State<UniversalSubjectSelector> {
  ...
  void _addSubject() {
    if (_ctrl.text.isNotEmpty) {
      setState(() {
        mySubjects.add(_ctrl.text.trim());
        _ctrl.clear();
      });
    }
  }
                ...
                Expanded(
                    child: TextField(
                        ...
                        decoration: const InputDecoration(
                            hintText: "Add a Subject (e.g. Further Math)"))),
                IconButton(
            ...
            ElevatedButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => UniversalExamSlipScreen(
                              studentName: _nameCtrl.text.isEmpty
                                  ? "STUDENT"
                                  : _nameCtrl.text,
