...
class HoloDeckViewer extends StatefulWidget {
  ...
  const HoloDeckViewer(
      {super.key, required this.modelUrl, required this.topic});
    ...
    return Stack(
      children: [
        ...
        ModelViewer(
          ...
          cameraControls: true,
          backgroundColor:
              Colors.transparent, // Crucial: Lets the camera show through
        ),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const Text("Tap 'View in your space' to project",
                            style:
