          ...
          return GestureDetector(
            onTap: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text("${persona.name} Selected!"),
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isSelected
                    ? persona.themeColor.withOpacity(0.2)
                    : Colors.white10,
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                    color: isSelected ? persona.themeColor : Colors.transparent,
                    width: 2),
              ),
              child: Column(
                ...
                children: [
                  Icon(persona.avatarIcon,
                      size: 40,
                      color: isSelected ? persona.themeColor : Colors.grey),
