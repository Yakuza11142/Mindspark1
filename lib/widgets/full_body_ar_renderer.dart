...
class FullBodyArRenderer extends StatelessWidget {
  ...
  const FullBodyArRenderer(
      {super.key, required this.characterName, required this.modelUrl});

  @override
  Widget build(BuildContext context) {
    return ModelViewer(
      src:
          modelUrl, // The compiled .glb file containing the full body + clothes
      ar: true,
      arPlacement: ArPlacement.floor,
      autoAnimate: true,
      animationName:
          SkeletalAnimationController.getIdleAnimation(characterName),
      cameraControls: true,
