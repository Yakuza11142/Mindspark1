...
class MegaUtils {
  ...
  static int multiplyBy11(int n) {
    /* Fast 11 trick */ return n * 11;
  }

  static double pythagoras(double a, double b) => sqrt(a * a + b * b);
  static double quadraticPlus(double a, double b, double c) =>
      (-b + sqrt(b * b - 4 * a * c)) / (2 * a);
  static double quadraticMinus(double a, double b, double c) =>
      (-b - sqrt(b * b - 4 * a * c)) / (2 * a);
  ...
  static double distance(double u, double a, double t) =>
      (u * t) + (0.5 * a * t * t);
  static double finalVelocitySq(double u, double a, double s) =>
      (u * u) + (2 * a * s);
  ...
  static double workDone(double f, double d, double theta) =>
      f * d * cos(degToRad(theta));
  ...
  static double idealGasVolume(double n, double t, double p) =>
      (n * 0.0821 * t) / p;
  ...
  static double massFromMoles(double moles, double molarMass) =>
      moles * molarMass;
  ...
  static String formatNaira(double amt) =>
  ...
  // ===========================================================================
  static int secondsPerQuestion(int totalTimeMins, int totalQuestions) =>
      (totalTimeMins * 60) ~/ totalQuestions;
