...
class MegaUtils {
  ...
  static double quadPlus(double a, double b, double c) =>
      (-b + sqrt(b * b - 4 * a * c)) / (2 * a);
  static double quadMinus(double a, double b, double c) =>
      (-b - sqrt(b * b - 4 * a * c)) / (2 * a);
  ...
  static double dist(double u, double a, double t) =>
      (u * t) + (0.5 * a * t * t);
  static double finalVelSq(double u, double a, double s) =>
      (u * u) + (2 * a * s);
  ...
  static double work(double f, double d, double thetaDeg) =>
      f * d * cos(degToRad(thetaDeg));
  ...
  // ===========================================================================
  static int calcJambAggregate(int eng, int sub2, int sub3, int sub4) =>
      eng + sub2 + sub3 + sub4;
  static double calcPostUtmeAggregate(
      int jambScore, int postUtmeScore, int oLevelPoints) {
    // Standard 50% JAMB, 30% POST-UTME, 20% O-LEVEL format used by many Nigerian Unis
    return ((jambScore / 400) * 50) +
        ((postUtmeScore / 100) * 30) +
        oLevelPoints;
  }
  ...
  // ===========================================================================
  static String cleanJambQuestion(String q) =>
